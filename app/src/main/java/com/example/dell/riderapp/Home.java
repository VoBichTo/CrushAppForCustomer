...
public class Home extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSettings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Home.this, CustomerSetting.class);
                startActivity(intent);
                return;
            }
        });
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                if (!driverFound && requestBol) {
                    ...
                    mCustomerDatabase.addListenerForSingleValueEvent(new ValueEventListener() { //hàm này để tìm trong bảng Driver có thằng nào có id = key k
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) { //nếu có thì trả ra dấtnapshot
